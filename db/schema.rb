...
ActiveRecord::Schema.define(version: 20_161_103_210_917) do
  ...
  create_table 'cities_users', id: false, force: :cascade do |t|
    ...
    t.index %w(city_id user_id), name: 'index_cities_users_on_city_id_and_user_id', using: :btree
    t.index %w(user_id city_id), name: 'index_cities_users_on_user_id_and_city_id', using: :btree
  end
  ...
  create_table 'expenses', force: :cascade do |t|
    ...
    t.integer 'amount_cents',    default: 0,     null: false
    t.string  'amount_currency', default: 'RUB', null: false
    t.index %w(expendable_type expendable_id), name: 'index_expenses_on_expendable_type_and_expendable_id', using: :btree
  end
  ...
  create_table 'external_links', force: :cascade do |t|
    ...
    t.index %w(linkable_type linkable_id), name: 'index_external_links_on_linkable_type_and_linkable_id', using: :btree
  end
